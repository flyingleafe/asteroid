...
class LibriMixTrip(Dataset):
    ...
    def __init__(
        self, csv_dir, task="sep_clean", sample_rate=16000, n_src=2, segment=3
    ):
    ...
    def __getitem__(self, idx):
        ...
        self.noise_path = row["noise_path"]
        sources_list = []
        ...
        # Read noise
        noise, _ = sf.read(self.noise_path, dtype="float32", start=start, stop=stop)
